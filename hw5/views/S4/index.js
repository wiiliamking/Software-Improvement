...
(function(){
  var Button, robot, addListenerToButtons, init, addListenerToBubble, initByLeaving, adder;
  Button = (function(){
  ...
  robot = {
    ...
    S4Poccess: function(){
      ...
      return $('.apb').click(function(){
        ...
        alert((function(){
          ...
          for (i$ = 0; i$ <= 4; ++i$) {
            i = i$;
            results$.push(String.fromCharCode(65 + this.order[i]));
          }
          return results$;
        }.call(this$)));
        if ($('.apb').hasClass('unclickable')) {
    ...
    getNext: function(){
      if (this.pointer + 1 < this.order.length) {
        return $(this.buttons[this.order[++this.pointer]]).click();
      } else {
